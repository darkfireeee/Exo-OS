...
touch kernel/src/process/lifecycle/fork.rs servers/init_server/src/*.rs kernel/src/arch/x86_64/exceptions.rs kernel/src/memory/virtual/fault/handler.rs kernel/src/arch/x86_64/spectre/kpti.rs kernel/src/memory/virtual/page_table/kpti_split.rs kernel/src/scheduler/core/switch.rs \
  kernel/src/process/signal/handler.rs kernel/src/memory/virtual/fault/cow.rs kernel/src/memory/virtual/fault/demand_paging.rs kernel/src/memory/physical/allocator/buddy.rs kernel/src/memory/virtual/address_space/user.rs kernel/src/memory/virtual/page_table/walker.rs kernel/src/fs/exofs/storage/virtio_adapter.rs kernel/src/syscall/fast_path.rs kernel/src/arch/x86_64/syscall.rs \
  kernel/src/syscall/dispatch.rs kernel/src/syscall/table.rs kernel/src/syscall/handlers/signal.rs kernel/src/syscall/fs_bridge.rs kernel/src/process/signal/handler.rs kernel/src/process/lifecycle/fork.rs kernel/src/scheduler/core/switch.rs kernel/src/fs/exofs/cache/blob_cache.rs servers/syscall_abi/src/lib.rs servers/init_server/src/service_table.rs kernel/src/memory/heap/allocator/hybrid.rs
