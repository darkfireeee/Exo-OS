...
pub use exo_phoenix_ssr::{
    ...
    SSR_LOG_AUDIT_OFFSET as SSR_LOG_AUDIT, SSR_MAX_CORES_LAYOUT as MAX_CORES,
    SSR_METRICS_OFFSET as SSR_METRICS_PUSH, SSR_PMC_OFFSET as SSR_PMC_SNAPSHOT, SSR_SIZE,
};
