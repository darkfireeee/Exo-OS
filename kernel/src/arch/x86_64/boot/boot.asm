...
; Point d'entrée depuis GRUB (Multiboot2) en mode protégé 32-bit
...
multiboot2_header_start:
    ...
    ; Info request tag
    align 8
    dw 1, 0                         ; Type=1 (info request), flags=0
    dd 8                            ; Size
...
_start:
    ...
    ; EAX = magic multiboot2 (0x36D76289)
    ; EBX = adresse de la structure multiboot2_info
...
; === FONCTION: Vérifier magic Multiboot2 ===
check_multiboot:
    cmp dword [multiboot_magic], 0x36D76289  ; Multiboot2 magic
    jne .no_multiboot
    ret
...
long_mode_start:
    ...
    ; Appeler boot_main (défini dans boot.c)
    call boot_main
