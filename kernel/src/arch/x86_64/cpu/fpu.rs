...
pub extern "C" fn arch_has_xsave() -> u8 {
    super::features::cpu_features_or_none().map_or(false, |features| features.has_xsave()) as u8
}
...
pub extern "C" fn arch_has_avx() -> u8 {
    super::features::cpu_features_or_none().map_or(false, |features| features.has_avx()) as u8
}
