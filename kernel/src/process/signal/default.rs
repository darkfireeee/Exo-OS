...
impl SigAction {
    pub const DFL: Self = Self {
        kind: SigActionKind::Term,
        handler: 0,
        flags: 0,
        mask: 0,
        restorer: 0,
    };
    pub const IGN: Self = Self {
