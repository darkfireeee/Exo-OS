// kernel/src/memory/numa/node.rs
// Compat — implémentation canonique dans physical/numa/node.rs.

#[allow(dead_code, unused_imports)]
pub use crate::memory::physical::numa::node::*;
...
impl NumaNodeTable {
    ...
    pub fn register_node(&self, cpu_mask: u64) -> u32 {
        ...
        let node = unsafe { &mut *((&self.nodes[id as usize] as *const NumaNode) as *mut NumaNode) };
