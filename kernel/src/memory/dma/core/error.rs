...
impl DmaError {
    ...
    pub const fn is_retriable(self) -> bool {
        matches!(self, DmaError::Timeout | DmaError::OutOfMemory | DmaError::NoChannel)
    }
}
...
impl DmaErrorCounters {
    ...
    pub fn hardware_total(&self) -> u64 {
        self.hardware_error.load(Ordering::Relaxed)
            + self.iommu_fault.load(Ordering::Relaxed)
    }
