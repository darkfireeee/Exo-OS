...
pub use deadline::{admit_thread, release_thread, refresh_deadline, check_deadline_miss, deadline_tick, DeadlineError};
pub use idle::{mark_idle_thread, is_idle_thread, idle_loop};
pub use ai_guided::{maybe_prefer, AI_HINTS_ENABLED};
