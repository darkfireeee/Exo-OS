//! Core VFS Types - Fundamental filesystem types
//!
//! Migrated from fs/core.rs to core/types.rs for better organization.
//! Contains all fundamental types used across the VFS layer.
...
impl Timestamp {
    ...
    pub fn now() -> Self {
        let sec = crate::time::unix_timestamp() as i64;
        let nsec = (crate::time::uptime_ns() % 1_000_000_000) as u32;
        Self { sec, nsec }
    }
