...
pub extern "C" fn exofs_syscall_handler(
    ...
    dispatch_exofs_syscall(ExofsSyscallArgs { nr, a1, a2, a3, a4, a5, a6 })
}
...
pub fn syscall_number(name: &[u8]) -> Option<u64> {
    ...
    while i < TABLE.len() {
        let (k, v) = TABLE[i];
        if bytes_eq(k, name) { return Some(v); }
        i = i.wrapping_add(1);
    }
    None
}
...
mod tests {
    ...
    fn test_dispatch_unknown_returns_enosys() {
        let args = ExofsSyscallArgs { nr: 9999, a1:0, a2:0, a3:0, a4:0, a5:0, a6:0 };
    ...
    fn test_dispatch_null_args_returns_efault() {
        ...
        while nr <= SYS_EXOFS_LAST {
            let args = ExofsSyscallArgs { nr, a1:0, a2:0, a3:0, a4:0, a5:0, a6:0 };
    ...
    fn test_counter_increments() {
        reset_all_counters();
        let args = ExofsSyscallArgs { nr: SYS_EXOFS_GC_TRIGGER, a1:0, a2:0, a3:0, a4:0, a5:0, a6:0 };
...
pub fn all_syscall_names() -> [&'static str; 19] {
    [
        "exofs_path_resolve",  "exofs_object_open",    "exofs_object_read",
        "exofs_object_write",  "exofs_object_create",  "exofs_object_delete",
        "exofs_object_stat",   "exofs_object_set_meta","exofs_get_content_hash",
        "exofs_snapshot_create","exofs_snapshot_list", "exofs_snapshot_mount",
        "exofs_relation_create","exofs_relation_query","exofs_gc_trigger",
        "exofs_quota_query",   "exofs_export_object",  "exofs_import_object",
        "exofs_epoch_commit",
    ]
}
