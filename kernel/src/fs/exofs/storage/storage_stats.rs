...
impl StorageStats {
    ...
    #[inline]
    pub fn inc_compress_op(&self) {
        self.compress_ops.fetch_add(1, Ordering::Relaxed);
    }

    pub fn add_compress_bytes_in(&self, n: u64) {
        self.compress_bytes_in.fetch_add(n, Ordering::Relaxed);
    }
