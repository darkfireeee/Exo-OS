...
impl DedupMode {
    pub fn is_active(&self) -> bool {
        !matches!(self, DedupMode::Disabled)
    }
...
mod tests {
    ...
    #[test]
    fn test_policy_disabled_not_active() {
    ...
    #[test]
    fn test_should_dedup_below_min_size() {
        let p = DedupPolicy::default();
        assert!(!p.should_dedup(100));
    }

    #[test]
    fn test_should_dedup_above_min_size() {
        let p = DedupPolicy::default();
    ...
    #[test]
    fn test_engine_default_returned_when_no_rules() {
    ...
    #[test]
    fn test_engine_first_matching_rule() {
...
mod tests_report {
    ...
    #[test]
    fn test_report_from_disabled() {
        let r = DedupPolicyReport::from_policy(&DedupPolicy::disabled());
        assert!(!r.is_active);
    }

    #[test]
    fn test_engine_report_for_size() {
