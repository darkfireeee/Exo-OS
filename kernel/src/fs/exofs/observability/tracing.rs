...
impl TraceFilter {
    pub const fn all() -> Self {
        Self {
            ...
            component_mask: u32::MAX,
        }
    }
    pub const fn errors() -> Self {
        Self {
            min_level: TraceLevel::Error,
            component_mask: u32::MAX,
        }
    }
    pub const fn warnings() -> Self {
        Self {
...
impl TraceRing {
    ...
    pub fn reset(&self) {
        ...
        while i < TRACE_RING_SIZE {
            ...
            unsafe {
                (*self.events.get())[i] = TraceEvent::zeroed();
            }
            i = i.wrapping_add(1);
        }
...
impl<'a> TraceSession<'a> {
    ...
    pub fn error(&self, msg: &str) {
        self.emit(TraceLevel::Error, msg);
    }
    pub fn warn(&self, msg: &str) {
        self.emit(TraceLevel::Warn, msg);
    }
    pub fn info(&self, msg: &str) {
        self.emit(TraceLevel::Info, msg);
    }
    pub fn debug(&self, msg: &str) {
        self.emit(TraceLevel::Debug, msg);
    }
    pub fn trace(&self, msg: &str) {
        self.emit(TraceLevel::Trace, msg);
    }
        ...
        while i < count {
            ...
            match TraceLevel::from_u8(evt.level) {
                ...
                TraceLevel::Debug | TraceLevel::Trace => {
                    s.debug_count = s.debug_count.saturating_add(1)
                }
                _ => {}
            }
            i = i.wrapping_add(1);
